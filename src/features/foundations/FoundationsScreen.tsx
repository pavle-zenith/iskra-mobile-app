...
/**
 * M0 acceptance screen, kept as the placeholder home until M3 builds the real one.
 *
 * Original M0 acceptance: "Šta te tačno vraća cigareti?" in Host Grotesk on paper,
